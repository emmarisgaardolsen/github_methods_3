...
From looking at the QQ plot, the old model seems to fulfil the assumptions of the GLM better. However, averaging the outcome variable across scenarious discards a lot of potentially usefull information, so in practice, it is not a very informative model.
...
It looks alright, although something seems to happen at the higher theoretical quantiles (skewness?)
...
The coefficient on the interaction term represents the difference in the slope for f0mn comparing 
