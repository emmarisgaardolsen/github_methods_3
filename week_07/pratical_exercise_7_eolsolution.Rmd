...
y_normal = np.random.normal(loc=0, scale = 5, size = len(y))
...
plt.plot(x, y, 'b') # plot a blue line
plt.plot(x,y_noisy,'go')
plt.xlabel('x values')
plt.title('Plot1: True function & generated points')
plt.legend(['Generated points', 'True function'])
plt.show()
...
x = x.reshape(61,1) # because this array is required to be two-dimensional, or to be more precise, to have one column and as many rows as necessary. 

model = regressor.fit(x,y_noisy)

r_sq = model.score(x, y_noisy)
...
plt.plot(x,y_pred, "b")
plt.title("plot")
plt.legend(["Function generated", "Linear regression"])
plt.show()
...
regressor = LinearRegression()
model_qua = regressor.fit(X_quadratic,y_noisy)
y_quadratic_hat = model_qua.predict(X_quadratic)
X_quadratic
...
plt.plot(x,y_noisy, "ro")
plt.plot(x,y_pred, "b")
plt.plot(x,y_quadratic_hat, "black")
plt.title("plot")
plt.legend(["Function generated", "Generated y-values", "Linear reg", "Quadratic model"])
plt.show()

  
```

X_quadratic amounts to the design matrix. 
...
regressor = LinearRegression()
model_fifth = regressor.fit(X_fifth,y_noisy)
y_fifth_hat = model_fifth.predict(X_fifth)
X_fifth
...
plt.plot(x,y_pred, "b")
plt.plot(x,y_quadratic_hat, "black")
plt.plot(x,y_fifth_hat, "orange")
plt.title("plot")
plt.legend(["Function generated", "Generated y-values", "Linear reg", "Quadratic mdoel", "5th order"])
plt.show()
